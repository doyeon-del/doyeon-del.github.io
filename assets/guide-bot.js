...
(function () {
  ...
  var KB = [
    ...
    },
    {
      ...
      answer:
        "「토끼와 거북목」 — 웹캠 기반 실시간 자세 감지·스트레칭 데스크톱 앱이에요. 온디바이스 AI(영상 미전송), 개인화 캘리브레이션, 알림 계층 설계가 특징이고 SSAFY 공통 프로젝트 3위를 했어요. 팀장·FE를 맡았습니다.",
  ...
  var SUGGESTIONS = ["어떤 프로젝트가 있어요?", "수상 이력은?", "기술 스택은?", "데이터 분석 결과물은?"];
  ...
  function ask(q) {
    ...
    if (hit) {
      ...
      addMsg(
        "그 키워드로는 찾지 못했어요. 아래 주제로 물어보시면 안내할 수 있어요 — 프로젝트 · 수상 · 기술 스택 · 데이터 분석 · 백엔드 · 경력/연락처",
        "bot",
